                ...
                <div className="max-w-[1700px] mx-auto">
                    ...
                    <div className="mt-12 max-w-[1700px] mx-auto">
                        <p className="text-gray-700 font-medium text-[22px] leading-relaxed text-justify">
                            SAS is a data management software that represents a set of tools used to manage, analyse, and interpret big amounts of data from raw data import to data transformation where the raw data is cleaned up for analysis. Next, with the support of statistics and predictive analytics software, users can execute deep analysis to find hidden trends and patterns and predict future outcomes. Finally, it helps to create dashboards, reports, and customized applications to make insight visible to key stakeholders in today’s data-driven business environments.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            ...
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Protect sensitive data with robust security
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            ...
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Explore</h3>
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Handle missing data, identify relationships, and forecast trends
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            ...
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Predict</h3>
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Enable predictive models to spot trends, risks, and opportunities effectively
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                                <div className="mb-4 flex justify-center">
                                    <img
                                        src="/images/sustained_scalability.png"
                                        alt="Assure"
                                        className="w-16 h-16 object-contain"
                                    />
                                </div>
                                <h3 className="text-2xl font-semibold text-gray-900 mb-3">Sustain</h3>
                                <p className="text-gray-800 text-xl leading-relaxed">
                                    Ensure data is consistent, trustworthy, and compliant with data privacy and regulations
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                                <div className="mb-4 flex justify-center">
                                    <img
                                        src="/images/business_intelligence.png"
                                        alt="Distribute"
                                        className="w-16 h-16 object-contain"
                                    />
                                </div>
                                <h3 className="text-2xl font-semibold text-gray-900 mb-3">Measure</h3>
                                <p className="text-gray-800 text-xl leading-relaxed">
                                    Build real-time dashboards, visualizations, and performance measurement reports
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-black text-white py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-[1700px] mx-auto flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-8">
                        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl font-light text-center lg:text-left leading-relaxed max-w-4xl">
                            We support you with in-depth analysis and performance indicators in the pursuit of excellence!
                        </h2>
                        <button
