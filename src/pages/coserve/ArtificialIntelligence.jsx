                ...
                <div className="max-w-[1700px] mx-auto">
                    ...
                    <div className="mt-12 max-w-[1700px] mx-auto">
                        <p className="text-gray-700 font-medium text-[22px] leading-relaxed text-justify">
                            Artificial Intelligence (AI) is the practice of computer simulation of human intelligence using machines. With AI, computers can: learn from data, identify patterns, understand language, interpret visuals and decisions, act without human intervention. Several applications of AI include virtual assistants and expert systems to self-driving cars and generative AI, which have altered and evolved over the past decade—and will continue to do so in the future.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            <div className="mb-4 flex justify-center">
                                <img
                                    src="/images/cost_reduction.png"
                                    alt="Identify"
                                    className="w-16 h-16 object-contain"
                                />
                            </div>
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Improve</h3>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            <div className="mb-4 flex justify-center">
                                <img
                                    src="/images/unbiase_decision.png"
                                    alt="Implement"
                                    className="w-16 h-16 object-contain"
                                />
                            </div>
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Ensure</h3>
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Eliminate human bias and ensure fairer outcome
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            ...
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Personalize</h3>
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Provide personalized reports and recommendations
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                                <div className="mb-4 flex justify-center">
                                    <img
                                        src="/images/reduce_human.png"
                                        alt="Assure"
                                        className="w-16 h-16 object-contain"
                                    />
                                </div>
                                <h3 className="text-2xl font-semibold text-gray-900 mb-3">Minimize</h3>
                                <p className="text-gray-800 text-xl leading-relaxed">
                                    Minimize errors by precise algorithms and predefined rules
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                                <div className="mb-4 flex justify-center">
                                    <img
                                        src="/images/data_drivien.png"
                                        alt="Distribute"
                                        className="w-16 h-16 object-contain"
                                    />
                                </div>
                                <h3 className="text-2xl font-semibold text-gray-900 mb-3">Forecast</h3>
                                <p className="text-gray-800 text-xl leading-relaxed">
                                    Identify patterns and trends using vast amount of data for better decision-making
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-black text-white py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-[1700px] mx-auto flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-8">
                        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-4xl font-light text-center lg:text-left leading-relaxed max-w-4xl">
                            We hold your hand with confidence because Artificial Intelligence relies solely on the facts and figures!
                        </h2>
                        <button
