                ...
                <div className="max-w-[1700px] mx-auto">
                    ...
                    <div className="mt-12 max-w-[1700px] mx-auto">
                        <p className="text-gray-700 font-medium text-[22px] leading-relaxed text-justify">
                            In today’s fast-evolving industrial landscape, the role of Operations is more critical than ever before in enhancing the traditional supply chains with modern innovations. An ideal Operations is essential for productivity, efficiency, cost control, quality assurance, and sustainable movement of goods as well as services. Controlling the cost and eliminating the waste improves the resource utilization, which in turn increases the holistic productivity of any organization and helps the bottom line.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            ...
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Shape up the facility with right layout
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            ...
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Maintain seamless supply chain with supplier partners
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            ...
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Monitor</h3>
                            <p className="text-gray-800 text-xl leading-relaxed">
                    ...
                    <div className="flex justify-center">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                                ...
                                <h3 className="text-2xl font-semibold text-gray-900 mb-3">Comply</h3>
                                <p className="text-gray-800 text-xl leading-relaxed">
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                                ...
                                <p className="text-gray-800 text-xl leading-relaxed">
                                    Lead production teams ensuring high engagement and performance
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="relative">
                ...
                <div className="bg-black text-white py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-[1700px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-4">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-light text-center sm:text-left">We hold your hand from the initial concept till the final customer!
                        </h2>
                        <button
