                ...
                <div className="max-w-[1700px] mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border-t-[#F37E3A] border-t-8">
                            <div className="p-6">
                                <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                                    Source strategically for real savings.
                                </h3>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border-t-[#288EC2] border-t-8">
                            <div className="p-6">
                                <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                                    Quality is not an act, we make it a habit.
                                </h3>
                                {/* <div className="flex justify-end">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border-t-[#6EBD49] border-t-8">
                            <div className="p-6">
                                <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                                    Logistics is vital to deliver to the destination.
                                </h3>
                                {/* <div className="flex justify-end">
                    ...
                    <div className="mt-12 max-w-[1700px] mx-auto">
                        <p className="text-gray-700 font-medium text-[22px] leading-relaxed text-justify">
                            In today's global marketplace, the source of a product or a service can either make or break the bottom line of an organization. Managing a sourcing initiative can be very complex due to vastly diversified cultures, wide spread supplier base, and continuously changing demands of the shorter product life cycles. A negligible lapse in quality can be disastrous to the overall credibility of an organization. The quality got to be right for the product to prosper at the targeted price point. Last but not the least, logistics decides the leader because the product has to be delivered at the right place and at the right time.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            <div className="mb-4 flex justify-center">
                                <img
                                    src="/images/identify_img.png"
                                    alt="Identify"
                                    className="w-16 h-16 object-contain"
                                />
                            </div>
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Identify</h3>
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Find real savings opportunities
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            ...
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Implement</h3>
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Locate right suppliers and execute agreements
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            ...
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Audit</h3>
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Conduct inspections to ensure all the protocols are satisfied
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                                <div className="mb-4 flex justify-center">
                                    <img
                                        src="/images/assure_img.png"
                                        alt="Assure"
                                        className="w-16 h-16 object-contain"
                                    />
                                </div>
                                <h3 className="text-2xl font-semibold text-gray-900 mb-3">Assure</h3>
                                <p className="text-gray-800 text-xl leading-relaxed">
                                    Ensure that a product is delivered as per the specifications
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                                ...
                                <h3 className="text-2xl font-semibold text-gray-900 mb-3">Distribute</h3>
                                <p className="text-gray-800 text-xl leading-relaxed">
                                    Improve time to market from the origin to the destination
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="relative">
                ...
                <div className="bg-black text-white py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-[1700px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-4">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-light text-center sm:text-left">We help you to get the right product at the right time in the right place!</h2>
                        <button
