        ...
        <>
                ...
                <div className="max-w-[1700px] mx-auto">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border-t-[#F37E3A] border-t-8">
                            <div className="p-6">
                                <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                                    Want to establish a wholly owned foreign entity in India?
                                </h3>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border-t-[#288EC2] border-t-8">
                            <div className="p-6">
                                <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                                    Want to setup a liaison office to manage suppliers in India?
                                </h3>
                                {/* <div className="flex justify-end">
                        ...
                        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border-t-[#6EBD49] border-t-8">
                            <div className="p-6">
                                <h3 className="text-2xl font-semibold text-gray-900 mb-4">
                                    Want to develop an in-house manufacturing facility in India?
                                </h3>
                                {/* <div className="flex justify-end">
                    ...
                    <div className="mt-12 max-w-[1700px] mx-auto">
                        <p className="text-gray-700 font-medium text-[22px] leading-relaxed text-justify">
                            Expanding a business internationally is inherently risky unless the company is well connected. We serve to strategically implement the expansion initiatives and mitigate the related risks in India in close partnership with the Government. Building an appropriate infrastructure is extremely vital and directly impacts the efficiency of any business. The design and development of the physical facility varies by country based on its culture, character, and construction codes. We work with absolute transparency to be aligned with the business requirements at every stage of the project. Winston Churchill rightly said that the way we shape our buildings is how we will be shaped.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            <div className="mb-4 flex justify-center">
                                <img
                                    src="/images/goverment_policy.png"
                                    alt="Identify"
                                    className="w-16 h-16 object-contain"
                                />
                            </div>
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Align</h3>
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Align investor expectations with the government policies
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            <div className="mb-4 flex justify-center">
                                <img
                                    src="/images/site_prepration.png"
                                    alt="Implement"
                                    className="w-16 h-16 object-contain"
                                />
                            </div>
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Prepare</h3>
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Site preparation, proposal negotiation, and contractor finalization
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                            <div className="mb-4 flex justify-center">
                                <img
                                    src="/images/interiors.png"
                                    alt="Audit"
                                    className="w-16 h-16 object-contain"
                                />
                            </div>
                            <h3 className="text-2xl font-semibold text-gray-900 mb-3">Confirm</h3>
                            <p className="text-gray-800 text-xl leading-relaxed">
                                Spec drawings confirmation for architecture, civil structure, MEP, and interiors
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-center">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl">
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                                <div className="mb-4 flex justify-center">
                                    <img
                                        src="/images/facility_handover.png"
                                        alt="Assure"
                                        className="w-16 h-16 object-contain"
                                    />
                                </div>
                                <h3 className="text-2xl font-semibold text-gray-900 mb-3">Handhold</h3>
                                <p className="text-gray-800 text-xl leading-relaxed">
                                    Handholding from permit approvals to ground breaking till the facility handover
                                </p>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-2xl px-10 py-6 text-center">
                                <div className="mb-4 flex justify-center">
                                    <img
                                        src="/images/timeframe.png"
                                        alt="Distribute"
                                        className="w-16 h-16 object-contain"
                                    />
                                </div>
                                <h3 className="text-2xl font-semibold text-gray-900 mb-3">Maximize</h3>
                                <p className="text-gray-800 text-xl leading-relaxed">
                                    Execute the short-to-long term plan to maximize the ROI in the stipulated timeframe
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div className="relative">
                ...
                <div className="bg-black text-white py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
                    <div className="max-w-[1700px] mx-auto flex flex-col sm:flex-row justify-between items-center gap-6 sm:gap-4">
                        <h2 className="text-2xl sm:text-3xl md:text-4xl font-light text-center sm:text-left">We support you with an ideal strategy for investing in India!</h2>
                        <button
